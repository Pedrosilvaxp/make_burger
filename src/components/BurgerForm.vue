        ...
        <div>
            <form id="burger-form" @submit="createBurger">
                <div class="input-container">
                    ...
                    <input type="text" name="" id="nome" v-model="nome" placeholder="Digite o seu nome">
                </div>
                <div class="input-container">
                    <label for="pao">Seu pão:</label>
                ...
                <div class="input-container">
                    <label for="carne">Sua carne:</label>
...
export default {
    ...
    methods: {
        ...
        async createBurger(event) {
            ...
            // Apagando texto após 3 segundos
